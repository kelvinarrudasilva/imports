# app.py — Dashboard Loja Importados completo
...
# ----------------------------
# Função para preparar vendas para display
...
with tabs[3]:
    ...
    if vendas_filtradas.empty:
        ...
        top_lucro = formatar_valor_reais(top_lucro, ["LUCRO_TOTAL"])
        fig3 = px.bar(top_lucro, x="PRODUTO", y="LUCRO_TOTAL", text="LUCRO_TOTAL")
        fig3.update_traces(textposition="inside")
        st.plotly_chart(fig3, use_container_width=True)
        st.dataframe(top_lucro, use_container_width=True)
